...
Partial Class frmShowOptions
    ...
    Private Sub InitializeComponent()
        ...
        'cmdExit
        '
        Me.cmdExit.Location = New System.Drawing.Point(221, 365)
    ...
    Friend WithEvents txtAgentIDAmadeus As TextBox
    Friend WithEvents txtAgentQueueAmadeus As TextBox
    Friend WithEvents Label5 As Label
    Friend WithEvents txtAgentOPQueueAmadeus As TextBox
    Friend WithEvents txtAgentName As TextBox
    Friend WithEvents Label1 As Label
    Friend WithEvents txtAgentEmail As TextBox
    Friend WithEvents Label4 As Label
    Friend WithEvents Label7 As Label
    Friend WithEvents txtOfficeCityCode As TextBox
    Friend WithEvents Label8 As Label
    Friend WithEvents Label9 As Label
    Friend WithEvents txtDBConnectionFile As TextBox
    Friend WithEvents txtOfficePCCAmadeus As TextBox
    ...
    Friend WithEvents txtOfficePhone As TextBox
    Friend WithEvents txtAOHPhone As TextBox
