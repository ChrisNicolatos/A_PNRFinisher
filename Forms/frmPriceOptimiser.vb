...
Public Class frmPriceOptimiser
    ...
    Private Shared Function OpenPNR1G(ByVal pPNR As String) As String
        Try
            OpenPNR1G = ""
            Dim pSession1G As New Travelport.TravelData.Factory.GalileoDesktopFactory(GALILEOSourceId, GALILEOConnectionName, GALILEOApolloMode, GALILEOIsApolloGalileoKeyboardMode, GALILEOVendorId)
