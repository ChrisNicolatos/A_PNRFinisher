Module _Version
    Public Const VersionText As String = "V 5.0 (18/02/2020 08:55)"
    Public Const GALILEOSourceId As String = "SPG720"
    Public Const GALILEOConnectionName As String = "MYCONNECTION"
    Public Const GALILEOApolloMode As Boolean = False
    Public Const GALILEOIsApolloGalileoKeyboardMode As Boolean = True
    Public Const GALILEOVendorId As String = "SMRT"
    ' 08/11/2018 17:11
    ...
    ' V 4.2 HOTFIX (31/01/2020 10:36)
    ' Galileo made some internal change and from today the Session Information command is not working
    ' I have replaced it with the OP/W* command to get user name and PCC
    ' V 5.0 (18/02/2020 08:55)
    ' I had to recompile to fix problems caused by new Galileo version 
    ' TODO
